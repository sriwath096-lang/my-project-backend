  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: '100%',
        maxWidth: '640px', /* ขยายกรอบให้กว้างและใหญ่ขึ้น */
        boxSizing: 'border-box'
      }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <div style={{
            width: '120px',  /* ขยายขนาดวงกลมโลโก้ให้ใหญ่สะใจ */
            height: '120px',
            background: '#ffffff',
        ...
        <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', gap: '22px', width: '100%' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', width: '100%' }}>
            ...
            />
            {errors.email && (
              <span style={{ fontSize: '13px', color: '#ef4444', fontWeight: '500' }}>{errors.email.message}</span>
            )}
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', width: '100%' }}>
            ...
            {errors.password && (
              <span style={{ fontSize: '13px', color: '#ef4444', fontWeight: '500' }}>{errors.password.message}</span>
            )}
          </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '30px', fontSize: '15px', color: '#64748b' }}>
          ยังไม่มีบัญชีผู้ใช้? <Link to="/register" style={{ color: '#2563eb', textDecoration: 'none', fontWeight: '600' }}>สมัครสมาชิกที่นี่</Link>
        </div>
